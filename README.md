# Update: Add Ocean D-wave SDK interface: FastHareComposite
A quick tutorial in Google Colab/ Jupyter Notebook [Jupyter Notebook](FastHare_Tutorial_Notebook.ipynb) (tested to work in Google Colab)
